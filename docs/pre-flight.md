...
| ⚠️ warn | Shipped `.bbl` has bbl format 3.2 (biblatex ≤ 3.19) | Accepted only when TeX Live 2023 is selected at submission — a choice arXiv plans to retire. Regenerate with biblatex ≥ 3.20 (bbl format 3.3). |
